...
const icons: { [key: string]: React.ReactNode } = {
  ...
  trim: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.848 8.25l1.536.887M7.848 8.25a3 3 0 11-5.196-3 3 3 0 015.196 3zM6.31 9.137l5.196 3M17.69 14.863l-5.196-3M17.69 14.863a3 3 0 115.196 3 3 3 0 01-5.196-3zM16.152 15.75l-1.536-.887" />
    </svg>
  ),
};
