...
const Canvas = forwardRef<HTMLDivElement, CanvasProps>(
    ({ sheetSize, images, pattern, selectedImageIds, onSelectImage, onUpdateImage, padding, zoom }, ref) => {
    const canvasStyle = {
    ...
    return (
      <div 
        ref={ref} 
        className="bg-slate-700 shadow-lg relative overflow-hidden transition-transform duration-150" 
        style={canvasStyle}
      >
        <div 
